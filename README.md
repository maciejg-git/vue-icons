...
Note: **registerIcon** is optional. It is just generic app.component function with some added functionality. You can register icons directly using app.component(icon). 
