...
export default {
  $_icon: {
    name: "GlobeAmericasFill",
    vendor: "B",
    license: "MIT",
    type: [],
    tags: ["globe","americas","fill"],
  },
  render() {
    return h(
      "svg",
