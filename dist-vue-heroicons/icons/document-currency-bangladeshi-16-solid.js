...
export default {
  $_icon: {
    ...
    license: "MIT",
    type: ["16","Solid"],
    tags: ["document","currency","bangladeshi"],
  },
  render() {
    return h(
      "svg",
