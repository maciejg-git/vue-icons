  ...
  render() {
    return h(
      ...
      [ 
        ...
        h(
          "path",
          {"fill-rule":"evenodd","d":"M2 3.5A1.5 1.5 0 0 1 3.5 2H6a1.5 1.5 0 0 1 1.5 1.5V6A1.5 1.5 0 0 1 6 7.5H3.5A1.5 1.5 0 0 1 2 6V3.5Zm1.5 0H6V6H3.5V3.5Z","clip-rule":"evenodd"}
        ),
        h(
          "path",
        ...
        h(
          "path",
          {"fill-rule":"evenodd","d":"M2 10a1.5 1.5 0 0 1 1.5-1.5H6A1.5 1.5 0 0 1 7.5 10v2.5A1.5 1.5 0 0 1 6 14H3.5A1.5 1.5 0 0 1 2 12.5V10Zm1.5 2.5V10H6v2.5H3.5Z","clip-rule":"evenodd"}
        ),
        h(
          "path",
        ...
        h(
          "path",
          {"fill-rule":"evenodd","d":"M10 2a1.5 1.5 0 0 0-1.5 1.5V6A1.5 1.5 0 0 0 10 7.5h2.5A1.5 1.5 0 0 0 14 6V3.5A1.5 1.5 0 0 0 12.5 2H10Zm2.5 1.5H10V6h2.5V3.5Z","clip-rule":"evenodd"}
        ),
        h(
          "path",
