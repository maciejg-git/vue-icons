...
export default {
  ...
  render() {
    return h(
      "svg",
      {"width":"24","height":"24","viewBox":"0 0 24 24","fill":"currentColor","xmlns":"http://www.w3.org/2000/svg","data-name":"h-gift"},
      [ 
        h(
          "path",
        ...
        h(
          "path",
          {"d":"M11.25 12.75H3V19.5C3 20.7426 4.00736 21.75 5.25 21.75H11.25V12.75Z","fill":"#0F172A"}
        ),
        h(
          "path",
          {"d":"M12.75 12.75V21.75H19.5C20.7426 21.75 21.75 20.7426 21.75 19.5V12.75H12.75Z","fill":"#0F172A"}
        ) 
      ]
    )
  }
