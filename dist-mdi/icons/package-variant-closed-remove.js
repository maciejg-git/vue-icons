...
export default {
  $_icon: {
    name: "PackageVariantClosedRemove",
    vendor: "Mdi",
    license: "Apache 2.0",
    type: [],
    tags: ["package","variant","closed","remove"],
  },
  render() {
    return h(
      "svg",
      {"xmlns":"http://www.w3.org/2000/svg","width":"24","height":"24","viewBox":"0 0 24 24","fill":"currentColor","data-name":"mdi-package-variant-closed-remove"},
      [ 
        h(
          "path",
