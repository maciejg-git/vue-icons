...
export default {
  $_icon: {
    ...
    vendor: "Mdi",
    type: [],
    tags: ["movie","open","star","outline"],
  },
  render() {
    return h(
      "svg",
      {"xmlns":"http://www.w3.org/2000/svg","width":"24","height":"24","viewBox":"0 0 24 24","fill":"currentColor","data-name":"mdi-movie-open-star-outline"},
      [ 
        h(
          "path",
