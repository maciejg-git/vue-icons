...
export default {
  $_icon: {
    ...
    license: "Apache 2.0",
    type: [],
    tags: ["clock","star","four","points","outline"],
  },
  render() {
    return h(
      "svg",
