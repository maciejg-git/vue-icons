...
export default {
  $_icon: {
    ...
    license: "Apache 2.0",
    type: [],
    tags: ["clipboard","clock","outline"],
  },
  render() {
    return h(
      "svg",
      {"xmlns":"http://www.w3.org/2000/svg","width":"24","height":"24","viewBox":"0 0 24 24","fill":"currentColor","data-name":"mdi-clipboard-clock-outline"},
      [ 
        h(
          "path",
