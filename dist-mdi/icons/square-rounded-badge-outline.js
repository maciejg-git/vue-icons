...
export default {
  $_icon: {
    ...
    vendor: "Mdi",
    type: [],
    tags: ["square","rounded","badge","outline"],
  },
  render() {
    return h(
      "svg",
      {"xmlns":"http://www.w3.org/2000/svg","width":"24","height":"24","viewBox":"0 0 24 24","fill":"currentColor","data-name":"mdi-square-rounded-badge-outline"},
      [ 
        h(
          "path",
