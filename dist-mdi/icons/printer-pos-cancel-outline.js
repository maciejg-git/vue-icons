...
export default {
  $_icon: {
    ...
    license: "Apache 2.0",
    type: [],
    tags: ["printer","pos","cancel","outline"],
  },
  render() {
    return h(
      "svg",
