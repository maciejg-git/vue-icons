...
export default {
  $_icon: {
    name: "AccountBoxPlusOutline",
    vendor: "Mdi",
    license: "Apache 2.0",
    type: [],
    tags: ["account","box","plus","outline"],
  },
  render() {
    return h(
      "svg",
