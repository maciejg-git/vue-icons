...
export default {
  $_icon: {
    ...
    vendor: "Test",
    type: "",
    tags: ["account","arrow","down","outline"],
  },
  render() {
    return h(
      "svg",
      {"xmlns":"http://www.w3.org/2000/svg","width":"24","height":"24","viewBox":"0 0 24 24","fill":"currentColor","data-name":"test-account-arrow-down-outline"},
      [ 
        h(
          "path",
